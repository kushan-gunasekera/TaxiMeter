...
public class LoginActivity extends AppCompatActivity {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                Log.i("TaxiMeter", "Google sign in failed", e);
                // ...
            }
        }
    }
    ...
    private void firebaseAuthWithGoogle(GoogleSignInAccount account) {
        Log.i("TaxiMeter", "firebaseAuthWithGoogle:" + account.getId());
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Log.i("TaxiMeter", "signInWithCredential:success");
                            FirebaseUser user = mAuth.getCurrentUser();
//                            updateUI(user);
                        } else {
                            // If sign in fails, display a message to the user.
                            Log.i("TaxiMeter", "signInWithCredential:failure", task.getException());
//                            Snackbar.make(normal, "Authentication Failed.", Snackbar.LENGTH_SHORT).show();
//                            updateUI(null);
                        }
